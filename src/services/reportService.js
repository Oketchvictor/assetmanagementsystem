...
// PDF Report Generation - Completely rewritten
...
const generateHTMLReport = (reportType, data, filters) => {
  ...
  switch (reportType) {
    ...
    case 'asset-assignment':
      ...
      break;
    default:
      tableHtml = '<p>Report data available</p>';
      break;
  }
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .status-active { background: rgba(0,229,168,0.12); color: #00E5A8; display: inline-block; padding: 3px 8px; border-radius: 12px; font-size: 10px; font-weight: 600; }
    .footer {
